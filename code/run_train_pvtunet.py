...
from MyDataset.transforms_tc import make_transforms
...
def main(fold):
    ...
    # train_dataset = BaseDataset(train_df, A.Compose(CFG.train_aug_list))
    # valid_dataset = BaseDataset(valid_df, A.Compose(CFG.valid_aug_list))
...
if __name__ == '__main__':
    ...
    for fold in range(CFG.num_fold-1, -1, -1):
        main(fold)
