## https://raw.githubusercontent.com/YehLi/ImageNetModel/main/semantic_segmentation/mmseg/models/backbones/dualvit.py
...
#----------------------------
# https://github.com/YehLi/ImageNetModel/blob/main/semantic_segmentation/configs/_base_/models/upernet_dualvit.py
# https://github.com/YehLi/ImageNetModel/blob/main/semantic_segmentation/configs/dualvit/upernet_dualvit_b_512x512_160k_ade20k.py
pretrain_dir = './pretrained/pvt_v2_b4.pth'
class dual_vit_b (DualVit):
	def __init__(self, **kwargs):
		super(dual_vit_b, self).__init__(
			stem_hidden_dim=64,
